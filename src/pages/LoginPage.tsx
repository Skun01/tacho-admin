    ...
    <div className="min-h-screen flex" style={{ backgroundColor: 'var(--surface)' }}>
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-2.5">
          <img src="/kitsune.svg" alt="Tacho logo" className="w-9 h-9 object-contain brightness-0 invert" />
          <span className="text-xl font-bold tracking-wide text-white">Tacho</span>
          <span
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-heading-vn text-4xl xl:text-5xl font-bold text-white leading-tight">
